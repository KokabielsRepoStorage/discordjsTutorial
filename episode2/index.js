...
const { Client, GatewayIntentBits, Collection } = require('discord.js'); //? Discord js allows easier access to use the discord api.
...
//? My files
const handler = require('./handler/index'); //? This is the handler folder.
